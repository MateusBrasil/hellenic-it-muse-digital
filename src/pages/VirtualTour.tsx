...
import { Menu, Camera, Box, Glasses } from 'lucide-react';
...
const VirtualTour = () => {
  ...
  const t = translations[currentVersion].virtualTour;
    ...
    <div className="min-h-screen bg-background text-foreground font-inter transition-colors">
      ...
      <div className="pt-20 transition-all duration-300">
        <div className="max-w-7xl mx-auto py-16 px-4">
          ...
          <div className="bg-card dark:bg-card rounded-2xl shadow-lg overflow-hidden mb-12">
            <div className="aspect-video w-full">
              <iframe 
                src="https://my.matterport.com/show/?m=CvCBtiQdsbY"
                className="w-full h-full border-0"
                allowFullScreen
                title="Hellenic IT Museum Virtual Tour"
                loading="lazy"
              >
              </iframe>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-card dark:bg-card rounded-2xl shadow-lg p-8">
              <div className="flex items-center mb-6">
                <Box className="w-8 h-8 text-primary mr-4" />
                <h2 className="text-2xl font-semibold">{t.controlsTitle}</h2>
              </div>
              <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                {t.controls.map((control, idx) => (
            ...
            <div className="bg-card dark:bg-card rounded-2xl shadow-lg p-8">
              <div className="flex items-center mb-6">
                <Camera className="w-8 h-8 text-primary mr-4" />
            ...
            <div className="bg-card dark:bg-card rounded-2xl shadow-lg p-8">
              <div className="flex items-center mb-6">
                <Glasses className="w-8 h-8 text-primary mr-4" />
                <h2 className="text-2xl font-semibold">{t.vrTitle}</h2>
              </div>
              <p className="text-gray-700 dark:text-gray-300 mb-6">{t.vrDesc}</p>
