...
const ExhibitsTemporary: React.FC = () => {
    ...
    <div className="min-h-screen bg-background text-foreground font-inter transition-colors">
      ...
      <div className="pt-20 transition-all duration-300">
        <section className="container mx-auto py-8 px-4">
          <h1 className="text-3xl font-bold mb-4">Temporary Exhibitions</h1>
          <img src="/img/placeholder.jpg" alt="Temporary Exhibitions" className="w-full max-w-md mx-auto mb-6 rounded shadow" />
          <p className="mb-4">Discover our rotating selection of special exhibitions, featuring rare items, guest collections, and unique themes from the world of technology and digital culture.</p>
        </section>
      </div>
    </div>
  );
...
export default ExhibitsTemporary; 