...
const ActivitiesWorkshops = () => {
  const { translations, currentVersion } = useLanguage();
  const t = translations[currentVersion].activities.workshops;
    ...
    <div className="min-h-screen bg-background text-foreground font-inter transition-colors">
      ...
      <div className="pt-20 transition-all duration-300">
        <div className="max-w-2xl mx-auto py-16 px-4">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">{t.description}</p>
          <div className="bg-gray-100 dark:bg-zinc-800 rounded-xl p-8 text-center text-gray-500 dark:text-gray-300">
            {t.description}
          </div>
        </div>
      </div>
...
export default ActivitiesWorkshops; 