...
const ExhibitsNetworking: React.FC = () => {
    ...
    <div className="min-h-screen bg-background text-foreground font-inter transition-colors">
      ...
      <div className="pt-20 transition-all duration-300">
        <section className="container mx-auto py-8 px-4">
          ...
          <img src="/img/placeholder.jpg" alt="Networking" className="w-full max-w-md mx-auto mb-6 rounded shadow" />
          <p className="mb-4">Discover the devices that connected the world: routers, modems, and networking equipment that enabled the internet era.</p>
        </section>
      </div>
    </div>
  );
...
export default ExhibitsNetworking; 