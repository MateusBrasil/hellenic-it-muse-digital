...
const ExhibitsComputers: React.FC = () => {
    ...
    <div className="min-h-screen bg-background text-foreground font-inter transition-colors">
      ...
      <div className="pt-20 transition-all duration-300">
        <section className="container mx-auto py-8 px-4">
          <h1 className="text-3xl font-bold mb-4">Computer Gallery</h1>
          <img src="/img/placeholder.jpg" alt="Computer Gallery" className="w-full max-w-md mx-auto mb-6 rounded shadow" />
          <p className="mb-4">Explore a gallery of computers from different eras, showcasing the evolution of hardware, design, and user experience in the digital age.</p>
        </section>
      </div>
    </div>
  );
...
export default ExhibitsComputers; 