    ...
    <div className="min-h-screen bg-background text-foreground font-inter transition-colors">
      ...
      <div className="pt-20 transition-all duration-300">
        <section className="container mx-auto py-8 px-4">
          <h1 className="text-3xl font-bold mb-4">Gaming History</h1>
          <img src="/img/placeholder.jpg" alt="Gaming History" className="w-full max-w-md mx-auto mb-6 rounded shadow" />
          <p className="mb-4">Relive the history of digital entertainment with our collection of consoles, arcades, and iconic games that defined generations.</p>
        </section>
      </div>
    </div>
  );
