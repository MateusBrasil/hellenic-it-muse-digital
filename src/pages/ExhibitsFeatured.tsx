...
const ExhibitsFeatured: React.FC = () => {
    ...
    <div className="min-h-screen bg-background text-foreground font-inter transition-colors">
      ...
      <div className="pt-20 transition-all duration-300">
        <section className="container mx-auto py-8 px-4">
          <h1 className="text-3xl font-bold mb-4">Don't Miss These!</h1>
          <img src="/img/placeholder.jpg" alt="Featured Exhibits" className="w-full max-w-md mx-auto mb-6 rounded shadow" />
          <p className="mb-4">Highlighted artifacts and must-see items from our collection. These pieces represent milestones in the history of information technology and digital innovation.</p>
        </section>
      </div>
    </div>
  );
...
export default ExhibitsFeatured; 